...
Cpu0TargetLowering::LowerReturn(SDValue Chain,
  ...
  CCState CCInfo(CallConv, IsVarArg, MF, RVLocs,
                 *DAG.getContext());
  Cpu0TargetLowering::Cpu0CC Cpu0CCInfo(CallConv, ABI.IsO32(), CCInfo);
...
Cpu0TargetLowering::Cpu0CC::
Cpu0CC(CallingConv::ID CC, bool IsO32_, CCState &Info,
...
analyzeReturn(const SmallVectorImpl<Ty> &RetVals, bool IsSoftFloat,
  ...
  for (unsigned I = 0, E = RetVals.size(); I < E; ++I) {
    ...
    if (Fn(I, VT, RegVT, CCValAssign::Full, Flags, const_cast<Type*>(RetTy), this->CCInfo)) {
#ifndef NDEBUG
